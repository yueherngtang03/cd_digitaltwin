...
namespace DeviceSimulator
{
    public static class AzureIoTHub
    {
        ...
        private static string device1Name = "Light4";
        private static string device1SharedAccessKey = "MQXcY7ZmWCzcvO7gD0mnq07tR3qpQHL4tAIoTMPu3cw=";
        ...
        public static async Task SendDeviceToCloudMessageAsync(CancellationToken cancelToken)
        {
            ...
            while (!cancelToken.IsCancellationRequested)
            {
                ...
                var telemetryDataPoint = new TrailerTelemetry
                {
                    ...
                    lightmaintenance = currentWatt < 8.0D,
                    lighton = currentOn
                };
